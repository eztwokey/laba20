...
# Навигация движения змейки
snake_x_nav = 0
snake_y_nav = 0

#Хранение координат и размеров змеи
snake_list = []
snake_size = 5
...
for i in range(presents_size):
    #Расположение и рисование подарков на экране
...
#Проверка касаний змеи подарков и удаление элементов
